...
class LogView(QtGui.QWidget):
    ...
    def append_command(self, text):
        self._text_view.setHtml(self._text_view.toHtml() + "<p style=\"color:white\">" + text.replace("\n", "<BR>") + "</p>")
        self._scroll()

    def append_output(self, text):
        self._text_view.setHtml(self._text_view.toHtml() + "<p style=\"color:green\">" + text.replace("\n", "<BR>") + "</p>")
        self._scroll()

    def append_error(self, text):
        self._text_view.setHtml(self._text_view.toHtml() + "<p style=\"color:red\">" + text.replace("\n", "<BR>") + "</p>")
        self._scroll()
